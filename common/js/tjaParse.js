var parseTjaFile = (function(){
	...
	return function(file, options) {
		...
		let targetCourse;
		let targetCourseFound = false;

		let checkAllCourse = !!options.checkAllCourse;
		let courseInfoEach = [];
		let unassignedCourseData = {};
		
		let bpm = 120;
		let scrollInitMultiplier = 1;
		let globalScrollMultiplier = 1;
		let balloons = [];
		let course = null;
		let unlabeledCourseCounter = 1;
